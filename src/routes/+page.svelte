<script lang="ts">
  ...
  const portfolioContent: any = {
    introduction: {
      ...
      description:
        "A software engineer from Dallas Texas. Have experience using React, Tailwind, Svelte and more. Looking for new and exciting projects in the software space. Let's connect!",
    ...
    experiences: [
      ...
      },
      {
        ...
        image:
          "https://pbs.twimg.com/profile_images/1455242126275526659/zNCAAELg_400x400.png",
      },
      {
        company: "Google",
        ...
        image:
          "https://images.ctfassets.net/y2vv62dcl0ut/4cecci3Vom9aGlDCMwLm0g/cc93483ede67e93325719a423254bf1d/square.jpg",
      },
    ],
    education: {
      image:
        "https://admission.stanford.edu/assets/cardinal/images/stanford_block_s_logo2.jpg",
    ...
    projects: [
      {
        ...
        technology: "Svelte",
        description:
          "Clutch Maps is a map based web app for finding fun driving routes near you. Built mainly using Svelte and the Mapbox API.",
        image: "Basic.png",
      ...
      },
      {
        ...
        technology: "Svelte",
        description:
          "A Svelte 5 Component library which uses Tailwind 4 and Lucide Icons. Useful copy-paste components, for free.",
        image: "coastal2.png",
...
>
  ...
  ></div>
  <button
    onclick={() => window.open("https://www.coastalui.com/", "_blank")}
    class="absolute bottom-3 left-1/2 -translate-x-1/2 text-faint text-sm flex items-center cursor-pointer"
  >
    <svg
